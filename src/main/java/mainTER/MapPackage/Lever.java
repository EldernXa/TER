...
public class Lever extends InteractiveObject{
    ...
    public void actionGenuine() {
        ...
        System.out.println("activation " + this.interactiveObject);
        System.out.println("coord X = " + this.interactiveObject.getX());
        System.out.println("coord X = " + this.interactiveObject.getY());

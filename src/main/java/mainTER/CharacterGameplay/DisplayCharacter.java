...
//            System.out.println("Taille de la liste : " + MapFileReader.detectableObjectArrayList.size());
            for (ObjectLinker objectLinker : Map.objectLinkers) {
                if(((objectLinker.getDetectableObject2()!= null)&&(objectLinker.getDetectableObject2().getAppropriateNode().getBoundsInParent().intersects(this.getAppropriateNode().getBoundsInParent()))||(objectLinker.getDetectableObject1().getAppropriateNode().getBoundsInParent().intersects(this.getAppropriateNode().getBoundsInParent())))){
                    try{
    ...
    public void death() {
        if(character.canDie()) {
            setX(Checkpoint.lastCheckpointCoord.getX());
            setY(Checkpoint.lastCheckpointCoord.getY());
        }
    }
